...
ssl_cafile: str = os.path.join(
    os.path.dirname(os.path.dirname(__file__)), "secrets/ca.pem"
)
ssl_certfile: str = os.path.join(
    os.path.dirname(os.path.dirname(__file__)), "secrets/client-cert.pem"
)
ssl_keyfile: str = os.path.join(
    os.path.dirname(os.path.dirname(__file__)), "secrets/client-key.pem"
)
_filepath = os.path.join(
    os.path.dirname(os.path.dirname(__file__)), "secrets/client-password"
)
